...
public class HttpRequestImpl implements HttpRequest {
    ...
    private HashMap<String, String> gueryParameters;
    ...
    private void initRequestUrl(String requestContent) {
        String[] fullRequestUrl = requestContent.split("[\\s\\?]");
        this.setRequestUrl(fullRequestUrl[1]);
        String debug = "3";
    }
    ...
    private void initQueryParameters(String requestContent) {
        ...
        this.gueryParameters = new HashMap<>();
        String queryString = fullRequestUrl.split("\\?")[1];
        String[] queryParams = queryString.split("&");
        for (String param : queryParams) {
            String[] queryParameter = param.split("=");
            this.gueryParameters.putIfAbsent(queryParameter[0], queryParameter[1]);
        }
