...
import softuni.domain.util.RepositoryActionInvoker;
import softuni.domain.util.RepositoryActionResult;
import softuni.domain.util.RepositoryActionResultImpl;
...
public class BaseRepository {
    private static final EntityManagerFactory ENTITY_MANAGER_FACTORY =
            Persistence.createEntityManagerFactory("chushka");
