...
import org.softuni.domain.util.RepositoryActionInvoker;
import org.softuni.domain.util.RepositoryActionResult;
import org.softuni.domain.util.RepositoryActionResultImpl;
...
public class BaseRepository {
    private static final EntityManagerFactory ENTITY_MANAGER_FACTORY =
            Persistence.createEntityManagerFactory("MeTube");
